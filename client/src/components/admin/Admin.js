    ...
    return (
        <BackgroundWrapper>
            <div className="flex flex-col h-auto overflow-y-auto md:flex-row p-5 ml-24 mr-8">
                <div className="w-full h-full mb-5 md:w-[200px] lg:w-[250px] xl:w-[300px] md:h-[500px] bg-gray-600/40 backdrop-blur-md p-5 rounded-xl md:mr-5 flex flex-col md:block justify-start overflow-x-auto md:overflow-visible border border-white/40 shadow-xl">
